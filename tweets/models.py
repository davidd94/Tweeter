...
class TweetQuerySet(models.QuerySet):
    ...
    def feed(self, user):
        ...
        followed_users_id = []
        if profile_exists:
            # one below is much more efficient query
        ...
        return self.filter( # same as "Model.objects" when imported in other modules
            Q(user__id__in=followed_users_id) | # <--- "|" is same as "or"
            Q(user=user)
